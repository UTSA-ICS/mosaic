...
"""
Routines for configuring Mosaic
"""
...
from mosaic.version import version_info as version
...
paste_deploy_opts = [
    cfg.StrOpt('flavor',
               help=_('Partial name of a pipeline in your paste configuration '
                      ...
                      '[pipeline:mosaic-api-keystone] use the value '
                      '"keystone"')),
...
common_opts = [
    ...
    cfg.StrOpt('data_api', default='mosaic.db.sqlalchemy.api',
...
CONF.import_opt('verbose', 'mosaic.openstack.common.log')
CONF.import_opt('debug', 'mosaic.openstack.common.log')
CONF.import_opt('log_dir', 'mosaic.openstack.common.log')
CONF.import_opt('log_file', 'mosaic.openstack.common.log')
CONF.import_opt('log_config', 'mosaic.openstack.common.log')
CONF.import_opt('log_format', 'mosaic.openstack.common.log')
CONF.import_opt('log_date_format', 'mosaic.openstack.common.log')
CONF.import_opt('use_syslog', 'mosaic.openstack.common.log')
CONF.import_opt('syslog_log_facility', 'mosaic.openstack.common.log')
...
def parse_cache_args(args=None):
    config_files = cfg.find_config_files(project='mosaic', prog='mosaic-cache')
