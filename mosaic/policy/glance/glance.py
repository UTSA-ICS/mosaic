...
from mosaic.common import exception
import mosaic.policy.glance.proxy
import mosaic.openstack.common.log as logging
from mosaic.openstack.common import policy
...
class Enforcer(object):
    ...
    def _check(self, context, rule, target, *args, **kwargs):
        """Verifies that the action is valid on the target in this context.
           ...
           :raises: `mosaic.common.exception.Forbidden`
...
class ImageRepoProxy(mosaic.policy.glance.proxy.Repo):
...
class ImageProxy(mosaic.policy.glance.proxy.Image):
...
class ImageFactoryProxy(mosaic.policy.glance.proxy.ImageFactory):
...
class ImageMemberFactoryProxy(mosaic.policy.glance.proxy.ImageMembershipFactory):
...
class ImageMemberRepoProxy(mosaic.policy.glance.proxy.Repo):
