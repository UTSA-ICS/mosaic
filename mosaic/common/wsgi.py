...
import mosaic.openstack.common.log as os_logging
...
class Server(object):
    ...
    def start(self, application, default_port):
        ...
        try:
            ...
            # NOTE(flaper87): When running mosaic-control,
            # (mosaic's functional tests, for example)
            # setpgid fails with EPERM as mosaic-control
            ...
            #
            # Running mosaic-(api|registry) is safe and
